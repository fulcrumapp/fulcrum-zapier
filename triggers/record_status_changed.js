...
module.exports = {
  key: 'record_status_changed',
  noun: 'Record',
  display: {
    label: 'Record Status Changed',
    description: 'Triggers when the status is changed on a record.',
    directions:
      'Log into Fulcrum and paste the below URL into the webhook setup field.',
    important: true,
    hidden: false,
  },
  operation: {
